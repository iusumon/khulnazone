...
<html lang="en">
	...
	<body>
		...
		<div id="tabs">
			<p class="top_heading">Contact Details</p>
			<ul>
				<li><a href="#view">View List</a></li>
				<li><a href="#entryform">New Contact </a></li>
			</ul>
		...
		<script type="text/javascript">
			var updateUrl = 'contacts_info/update_data',
			deleteUrl = 'contacts_info/delete_data',
			delHref,
			updateHref,
			updateId,
			update_position,
			...
			$(function() {
				...
				$('#entrySubmit').button().click(function() {
					...
					jsonStr = {"contact_name":$('#contact_name').val(),
                                                   ...
                                                   "remarks":$('#remarks').val()};
					$.ajax({
						url: '<?php echo site_url("contacts_info/save_data"); ?>',
						type: 'POST',
                                                dataType:'json',
				...
				$('#delConfDialog').dialog({
					...
					buttons: {
						...
						'Yes': function() {
							...
							$.ajax({
								url: '<?php echo site_url("contacts_info/delete_data"); ?>' + '/' + $('#contact_id').val(),
								success: function(response) {
				...
				$("#records").delegate("a.updateBtn", "click", function() {
					...
					$.ajax({
						url: '<?php echo site_url("contacts_info/getById") . "/"; ?>' + updateId,
						dataType: 'json',
						success: function(response){
				...
				$('#update').button().click(function() {
                                        ...
                                        jsonStr = {"contact_id":$('#contact_id').val(),
                                                   ...
                                                   "remarks":$('#remarks').val()};
                                        $.ajax({
						url: '<?php echo site_url("contacts_info/update_data"); ?>',
						type: 'POST',
						dataType:'json',
						data: {'jsarray': $.toJSON(jsonStr)},
